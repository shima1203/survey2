...
from function import mince_data,mouse_speed,mouse_speed_click_pre,mouse_event_click_pre,mouse_speed_click_rear,mouse_event_click_rear,mouse_speed_scroll_rear,mouse_event_scroll_rear,test
...
for i in range(len(answer_id_list)):
    ...
    data_tmp['ratio_mouse_speed_click_pre'] = mouse_speed_click_pre(coordinates_dict[answer_id_list[i]], click_dict[answer_id_list[i]])/data_tmp['mouse_ave']                       #通常のマウススピードとクリック直前のマウススピードの比較
    ...
    data_tmp['ratio_mouse_speed_click_rear'] = mouse_speed_click_rear(coordinates_dict[answer_id_list[i]], click_dict[answer_id_list[i]])/data_tmp['mouse_ave']                     #通常のマウススピードとクリック直後のマウススピードの比較
