                            ...
                            <div class="form-group text-left">
                                ...
                                <?php if($question["qtype"] == "radio"){?>
                                    <a><?php $items = explode(",", $question['items']); 
                                        ...
                                        echo '<label for="'. $question['question_id'].'.'. '-1.未選択' .'" style="display: none;"><input type="radio" name="'. $question['question_id']. '" value="' . '-1.未選択' . '" id="'. $question['question_id'].'.'. '-1.未選択' . '" checked="checked" style="display: none;">' . '未選択' . '</label>' . "<br />";
                                        ?>
                                    </a>
