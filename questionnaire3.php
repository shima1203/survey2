                            ...
                            <div class="form-group text-left">
                                ...
                                <?php if($question["qtype"] == "radio"){?>
                                    <a><?php $items = explode(",", $question['items']); 
                                        ...
                                        echo '<label for="'. $question['question_id'].'.'. '-1.未選択' .'"><input type="hidden" name="'. $question['question_id']. '" value="' . '-1.未選択' . '" id="'. $question['question_id'].'.'. '-1.未選択' . ' checked="checked"">' . '未選択' . '</label>' . "<br />";
                                        ?>
                                    </a>
