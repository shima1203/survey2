...
for i in range(len(answer_id_list)):
    ...
    data_tmp['ratio_mouse_speed_scroll_rear'] = mouse_speed_scroll_rear(coordinates_dict[answer_id_list[i]], scroll_dict[answer_id_list[i]])/mouse_speed(coordinates_dict[answer_id_list[i]])
