    ...
    <body class="text-center box1" >
        <div class="card mx-auto"style="width: 750px;top:150px">
            ...
            <div class="card-header" style="background-color: rgba(100,100,100,.1);font-size:20px">
                ...
                <p size="3" style="text-align:left; font-size:15px">
                    <ul>
                        <li>このアンケートは高専生活アンケートを模して作成したものです。実際の高専生活アンケートとは異なりますのでご注意ください</li>
                        <li>回答内容は外部に漏れることもありますし、秘密にされる保証はありませんので、知られたく内容を答えないようにお願いいたします</li>
                        <li>また、良くも悪くも回答内容は見ませんので、いじめ等に関して真面目に相談されても対応しかねます。ご了承ください</li>
                    </ul>
                    <br>

                    <回答方法><br>
                    1回目:しっかり問題文を読んで”集中して”回答ください　この際、「集中」を最初に選択ください<br>
                    &nbsp 本当に思っていることを愚直に回答する必要はありませんが、実際のアンケートに答えているつもりで集中して回答ください<br>
